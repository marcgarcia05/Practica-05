                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center align-middle">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 align-items-center order-1 order-lg-2">
                                    <form action="../Controlador/forgotpasswd.php" method="post">
                                        <div class="divider d-flex align-items-center my-4">
                                            <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Forgot Password</p>
                                        </div>

                                        <div data-mdb-input-init class="form-outline mb-3">
                                            <input type="email" id="email" name="forgotEmail" class="form-control form-control-lg" value=""/>
